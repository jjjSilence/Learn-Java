package com.example.concurrency;//: concurrency/MapComparisons.java
// {Args: 1 10 10} (Fast verification check during build)
// Rough comparison of thread-safe Map performance.

import com.example.net.mindview.util.CountingGenerator;
import com.example.net.mindview.util.MapData;
